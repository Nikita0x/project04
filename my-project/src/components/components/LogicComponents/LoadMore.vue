<template>
    ...
    <button v-else="!store.state.pixabaydata && isLoading === true"  disabled type="button" class="flex justify-center mb-20 text-white bg-[#101619] hover:bg-[#050708]/80 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-lg px-5 py-2.5 text-center items-center dark:hover:bg-[#050708]/40 dark:focus:ring-gray-600 transition">
      <div>
